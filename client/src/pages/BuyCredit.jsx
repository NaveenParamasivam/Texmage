...
const {user} =useContext(AppContext)
  ...
  return (
    ...
    className="min-h-[80vh] text-center pt-14 mb-10">
      <button className="border border-gray-400 px-10 py-2 rounded-full md-6">Our Plans</button>
      <h1 className="text-center mt-2 text-3xl font-medium md-6 sm:mb-10">Choose The Plan</h1>
